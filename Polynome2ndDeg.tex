\documentclass{article} % Classe de document (article, report, book, etc.)

\usepackage[utf8]{inputenc} % Encodage pour les accents
\usepackage[T1]{fontenc}    % Encodage des caractères
\usepackage[french]{babel}  % Langue du document (ici, français)
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{tikz}
\usepackage{tkz-tab}
